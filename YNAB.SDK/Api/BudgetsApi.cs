...
namespace YNAB.SDK.Api
{
    ...
    public interface IBudgetsApiSync : IApiAccessor
    {
        ...
        ApiResponse<BudgetDetailResponse> GetBudgetByIdWithHttpInfo (string budgetId, long? lastKnowledgeOfServer = null);
        /// <summary>
        /// Budget Settings
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<BudgetSummaryResponse> GetBudgetsWithHttpInfo ();
    ...
    public interface IBudgetsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BudgetSummaryResponse> GetBudgetsAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<BudgetSummaryResponse>> GetBudgetsAsyncWithHttpInfo ();
    ...
    public partial class BudgetsApi : IBudgetsApi
    {
        ...
        /// <param name="lastKnowledgeOfServer">The starting server knowledge.  If provided, only entities that have changed since last_knowledge_of_server will be included. (optional)</param>
        /// <returns>BudgetDetailResponse</returns>
        public BudgetDetailResponse GetBudgetById (string budgetId, long? lastKnowledgeOfServer = null)
        {
        ...
        /// <param name="lastKnowledgeOfServer">The starting server knowledge.  If provided, only entities that have changed since last_knowledge_of_server will be included. (optional)</param>
        /// <returns>ApiResponse of BudgetDetailResponse</returns>
        public YNAB.SDK.Client.ApiResponse< BudgetDetailResponse > GetBudgetByIdWithHttpInfo (string budgetId, long? lastKnowledgeOfServer = null)
        {
            ...
            var response = this.Client.Get< BudgetDetailResponse >("/budgets/{budget_id}", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetBudgetById", response);
        ...
        /// <param name="lastKnowledgeOfServer">The starting server knowledge.  If provided, only entities that have changed since last_knowledge_of_server will be included. (optional)</param>
        /// <returns>Task of ApiResponse (BudgetDetailResponse)</returns>
        public async System.Threading.Tasks.Task<YNAB.SDK.Client.ApiResponse<BudgetDetailResponse>> GetBudgetByIdAsyncWithHttpInfo (string budgetId, long? lastKnowledgeOfServer = null)
        {
            // verify the required parameter 'budgetId' is set
            if (budgetId == null)
                throw new YNAB.SDK.Client.ApiException(400, "Missing required parameter 'budgetId' when calling BudgetsApi->GetBudgetById");
            ...
            var response = await this.AsynchronousClient.GetAsync<BudgetDetailResponse>("/budgets/{budget_id}", requestOptions, this.Configuration);
        ...
        public YNAB.SDK.Client.ApiResponse< BudgetSettingsResponse > GetBudgetSettingsByIdWithHttpInfo (string budgetId)
        {
            ...
            var response = this.Client.Get< BudgetSettingsResponse >("/budgets/{budget_id}/settings", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetBudgetSettingsById", response);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="budgetId">The id of the budget (\&quot;last-used\&quot; can be used to specify the last used budget and \&quot;default\&quot; can be used if default budget selection is enabled (see: https://api.youneedabudget.com/#oauth-default-budget)</param>
        /// <returns>Task of ApiResponse (BudgetSettingsResponse)</returns>
        public async System.Threading.Tasks.Task<YNAB.SDK.Client.ApiResponse<BudgetSettingsResponse>> GetBudgetSettingsByIdAsyncWithHttpInfo (string budgetId)
        {
            // verify the required parameter 'budgetId' is set
            if (budgetId == null)
                throw new YNAB.SDK.Client.ApiException(400, "Missing required parameter 'budgetId' when calling BudgetsApi->GetBudgetSettingsById");
            ...
            var response = await this.AsynchronousClient.GetAsync<BudgetSettingsResponse>("/budgets/{budget_id}/settings", requestOptions, this.Configuration);
        ...
        /// <exception cref="YNAB.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of BudgetSummaryResponse</returns>
        public YNAB.SDK.Client.ApiResponse< BudgetSummaryResponse > GetBudgetsWithHttpInfo ()
        {
            YNAB.SDK.Client.RequestOptions requestOptions = new YNAB.SDK.Client.RequestOptions();
            ...
            var response = this.Client.Get< BudgetSummaryResponse >("/budgets", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetBudgets", response);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="YNAB.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (BudgetSummaryResponse)</returns>
        public async System.Threading.Tasks.Task<YNAB.SDK.Client.ApiResponse<BudgetSummaryResponse>> GetBudgetsAsyncWithHttpInfo ()
        {
            ...
            var response = await this.AsynchronousClient.GetAsync<BudgetSummaryResponse>("/budgets", requestOptions, this.Configuration);
