...
namespace YNAB.SDK.Api
{
    ...
    public interface IAccountsApiSync : IApiAccessor
    {
        ...
        ApiResponse<AccountsResponse> GetAccountsWithHttpInfo (string budgetId, long? lastKnowledgeOfServer = null);
    ...
    public interface IAccountsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<AccountsResponse>> GetAccountsAsyncWithHttpInfo (string budgetId, long? lastKnowledgeOfServer = null);
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        public YNAB.SDK.Client.ApiResponse< AccountResponse > GetAccountByIdWithHttpInfo (string budgetId, Guid accountId)
        {
            ...
            if (accountId == null)
                throw new YNAB.SDK.Client.ApiException(400, "Missing required parameter 'accountId' when calling AccountsApi->GetAccountById");
            ...
            var response = this.Client.Get< AccountResponse >("/budgets/{budget_id}/accounts/{account_id}", requestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetAccountById", response);
        ...
        {
             YNAB.SDK.Client.ApiResponse<AccountResponse> localVarResponse = await GetAccountByIdAsyncWithHttpInfo(budgetId, accountId);
             return localVarResponse.Data;
        ...
        /// <param name="accountId">The id of the account</param>
        /// <returns>Task of ApiResponse (AccountResponse)</returns>
        public async System.Threading.Tasks.Task<YNAB.SDK.Client.ApiResponse<AccountResponse>> GetAccountByIdAsyncWithHttpInfo (string budgetId, Guid accountId)
        {
            // verify the required parameter 'budgetId' is set
            if (budgetId == null)
                throw new YNAB.SDK.Client.ApiException(400, "Missing required parameter 'budgetId' when calling AccountsApi->GetAccountById");
            ...
            var response = await this.AsynchronousClient.GetAsync<AccountResponse>("/budgets/{budget_id}/accounts/{account_id}", requestOptions, this.Configuration);
        ...
        /// <param name="lastKnowledgeOfServer">The starting server knowledge.  If provided, only entities that have changed since last_knowledge_of_server will be included. (optional)</param>
        /// <returns>AccountsResponse</returns>
        public AccountsResponse GetAccounts (string budgetId, long? lastKnowledgeOfServer = null)
        {
        ...
        {
             YNAB.SDK.Client.ApiResponse<AccountsResponse> localVarResponse = await GetAccountsAsyncWithHttpInfo(budgetId, lastKnowledgeOfServer);
             return localVarResponse.Data;
        ...
        /// <param name="lastKnowledgeOfServer">The starting server knowledge.  If provided, only entities that have changed since last_knowledge_of_server will be included. (optional)</param>
        /// <returns>Task of ApiResponse (AccountsResponse)</returns>
        public async System.Threading.Tasks.Task<YNAB.SDK.Client.ApiResponse<AccountsResponse>> GetAccountsAsyncWithHttpInfo (string budgetId, long? lastKnowledgeOfServer = null)
        {
            // verify the required parameter 'budgetId' is set
            if (budgetId == null)
                throw new YNAB.SDK.Client.ApiException(400, "Missing required parameter 'budgetId' when calling AccountsApi->GetAccounts");
            ...
            var response = await this.AsynchronousClient.GetAsync<AccountsResponse>("/budgets/{budget_id}/accounts", requestOptions, this.Configuration);
