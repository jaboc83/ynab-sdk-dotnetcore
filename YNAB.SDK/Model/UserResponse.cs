...
namespace YNAB.SDK.Model
{
    ...
    public partial class UserResponse : IEquatable<UserResponse>, IValidatableObject
    {
        ...
        public UserResponse(UserResponseData data = default(UserResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for UserResponse and cannot be null");
        }
