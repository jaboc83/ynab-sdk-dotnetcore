...
namespace YNAB.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MonthSummariesResponse")]
    public partial class MonthSummariesResponse : IEquatable<MonthSummariesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public MonthSummariesResponse(MonthSummariesResponseData data = default(MonthSummariesResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for MonthSummariesResponse and cannot be null");
        }
