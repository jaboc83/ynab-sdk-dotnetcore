...
namespace YNAB.SDK.Model
{
    ...
    public partial class TransactionsResponse : IEquatable<TransactionsResponse>, IValidatableObject
    {
        ...
        public TransactionsResponse(TransactionsResponseData data = default(TransactionsResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for TransactionsResponse and cannot be null");
        }
