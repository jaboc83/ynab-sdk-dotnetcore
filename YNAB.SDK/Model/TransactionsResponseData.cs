...
namespace YNAB.SDK.Model
{
    ...
    public partial class TransactionsResponseData :  IEquatable<TransactionsResponseData>, IValidatableObject
    {
        ...
        protected TransactionsResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionsResponseData" /> class.
        /// </summary>
        /// <param name="transactions">transactions (required).</param>
        /// <param name="serverKnowledge">The knowledge of the server (required).</param>
        public TransactionsResponseData(List<TransactionDetail> transactions = default(List<TransactionDetail>), long serverKnowledge = default(long))
        {
            // to ensure "transactions" is required (not null)
            if (transactions == null)
            {
                throw new InvalidDataException("transactions is a required property for TransactionsResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serverKnowledge is a required property for TransactionsResponseData and cannot be null");
            }
            else
            {
