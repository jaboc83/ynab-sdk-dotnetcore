...
namespace YNAB.SDK.Model
{
    ...
    public partial class ScheduledTransactionDetailAllOf :  IEquatable<ScheduledTransactionDetailAllOf>, IValidatableObject
    {
        ...
        public ScheduledTransactionDetailAllOf(string accountName = default(string), string payeeName = default(string), string categoryName = default(string), List<ScheduledSubTransaction> subtransactions = default(List<ScheduledSubTransaction>))
        {
            ...
            if (accountName == null)
            {
                throw new InvalidDataException("accountName is a required property for ScheduledTransactionDetailAllOf and cannot be null");
            }
            else
            {
            ...
            if (payeeName == null)
            {
                throw new InvalidDataException("payeeName is a required property for ScheduledTransactionDetailAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("categoryName is a required property for ScheduledTransactionDetailAllOf and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subtransactions is a required property for ScheduledTransactionDetailAllOf and cannot be null");
            }
            else
            {
