...
namespace YNAB.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SaveTransaction :  IEquatable<SaveTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveTransaction" /> class.
        /// </summary>
        ...
        public SaveTransaction(Guid accountId = default(Guid), DateTime date = default(DateTime), long amount = default(long), Guid payeeId = default(Guid), string payeeName = default(string), Guid categoryId = default(Guid), string memo = default(string), ClearedEnum? cleared = default(ClearedEnum?), bool approved = default(bool), FlagColorEnum? flagColor = default(FlagColorEnum?), string importId = default(string))
        {
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for SaveTransaction and cannot be null");
            }
            else
            {
                this.Date = date;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for SaveTransaction and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        {
            return this.Equals(input as SaveTransaction);
        }

        /// <summary>
        /// Returns true if SaveTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of SaveTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaveTransaction input)
        {
            if (input == null)
                return false;
