...
namespace YNAB.SDK.Model
{
    ...
    public partial class PayeesResponseData :  IEquatable<PayeesResponseData>, IValidatableObject
    {
        ...
        public PayeesResponseData(List<Payee> payees = default(List<Payee>), long serverKnowledge = default(long))
        {
            ...
            if (payees == null)
            {
                throw new InvalidDataException("payees is a required property for PayeesResponseData and cannot be null");
            }
            else
            {
                this.Payees = payees;
            ...
            {
                throw new InvalidDataException("serverKnowledge is a required property for PayeesResponseData and cannot be null");
            }
            else
            {
