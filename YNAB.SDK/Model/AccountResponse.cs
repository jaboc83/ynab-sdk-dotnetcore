...
namespace YNAB.SDK.Model
{
    ...
    public partial class AccountResponse : IEquatable<AccountResponse>, IValidatableObject
    {
        ...
        public AccountResponse(AccountResponseData data = default(AccountResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for AccountResponse and cannot be null");
        }
