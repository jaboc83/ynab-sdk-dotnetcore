...
namespace YNAB.SDK.Model
{
    ...
    public partial class BulkResponse : IEquatable<BulkResponse>, IValidatableObject
    {
        ...
        public BulkResponse(BulkResponseData data = default(BulkResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for BulkResponse and cannot be null");
        }
