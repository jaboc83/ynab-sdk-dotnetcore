...
namespace YNAB.SDK.Model
{
    ...
    public partial class ErrorDetail : IEquatable<ErrorDetail>, IValidatableObject
    {
        ...
        public ErrorDetail(string id = default(string), string name = default(string), string detail = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ErrorDetail and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ErrorDetail and cannot be null");
            // to ensure "detail" is required (not null)
            this.Detail = detail ?? throw new ArgumentNullException("detail is a required property for ErrorDetail and cannot be null");
        }
