...
namespace YNAB.SDK.Model
{
    ...
    public partial class CategoryResponse : IEquatable<CategoryResponse>, IValidatableObject
    {
        ...
        public CategoryResponse(CategoryResponseData data = default(CategoryResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for CategoryResponse and cannot be null");
        }
