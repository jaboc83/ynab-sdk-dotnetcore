...
namespace YNAB.SDK.Model
{
    ...
    public partial class AccountsResponse : IEquatable<AccountsResponse>, IValidatableObject
    {
        ...
        public AccountsResponse(AccountsResponseData data = default(AccountsResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for AccountsResponse and cannot be null");
        }
