...
namespace YNAB.SDK.Model
{
    ...
    public partial class ScheduledTransactionsResponseData :  IEquatable<ScheduledTransactionsResponseData>, IValidatableObject
    {
        ...
        public ScheduledTransactionsResponseData(List<ScheduledTransactionDetail> scheduledTransactions = default(List<ScheduledTransactionDetail>), long serverKnowledge = default(long))
        {
            ...
            {
                throw new InvalidDataException("scheduledTransactions is a required property for ScheduledTransactionsResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serverKnowledge is a required property for ScheduledTransactionsResponseData and cannot be null");
            }
            else
            {
