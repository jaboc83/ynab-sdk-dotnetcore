...
namespace YNAB.SDK.Model
{
    ...
    public partial class CategoriesResponse : IEquatable<CategoriesResponse>, IValidatableObject
    {
        ...
        public CategoriesResponse(CategoriesResponseData data = default(CategoriesResponseData))
        {
            // to ensure "data" is required (not null)
            this.Data = data ?? throw new ArgumentNullException("data is a required property for CategoriesResponse and cannot be null");
        }
