...
namespace YNAB.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BudgetSummaryResponse")]
    public partial class BudgetSummaryResponse : IEquatable<BudgetSummaryResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BudgetSummaryResponse);
        }

        /// <summary>
        /// Returns true if BudgetSummaryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BudgetSummaryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BudgetSummaryResponse input)
        {
            if (input == null)
                return false;
