...
namespace YNAB.SDK.Model
{
    ...
    public partial class CategoriesResponseData :  IEquatable<CategoriesResponseData>, IValidatableObject
    {
        ...
        public CategoriesResponseData(List<CategoryGroupWithCategories> categoryGroups = default(List<CategoryGroupWithCategories>), long serverKnowledge = default(long))
        {
            ...
            {
                throw new InvalidDataException("categoryGroups is a required property for CategoriesResponseData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serverKnowledge is a required property for CategoriesResponseData and cannot be null");
            }
            else
            {
