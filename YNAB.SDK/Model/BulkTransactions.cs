...
namespace YNAB.SDK.Model
{
    ...
    /// BulkTransactions
    /// </summary>
    [DataContract(Name = "BulkTransactions")]
    public partial class BulkTransactions : IEquatable<BulkTransactions>, IValidatableObject
    {
        /// <summary>
        ...
        public BulkTransactions(List<SaveTransaction> transactions = default(List<SaveTransaction>))
        {
            ...
            this.Transactions = transactions ?? throw new ArgumentNullException("transactions is a required property for BulkTransactions and cannot be null");
        }
